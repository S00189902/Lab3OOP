...
namespace Ex_5
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Total money from all registers : {0}", CashRegister.totalAllReg);
            Console.WriteLine("Total items from all the registers : {0}", CashRegister.totalItemsAllReg);
        }
    }
}
